...
def rnn_forward(x, h0, Wx, Wh, b):
    ...
    sequence composed of T vectors, each of dimension9  D. The RNN uses a hidden
    ...
    for i in range(T):
        cur_x = x[:, i, :]
        prev_h = h_list[i]
        next_h, cur_cache = rnn_step_forward(cur_x, prev_h, Wx, Wh, b)
...
def rnn_backward(dh, cache):
    ...
    for i in range(T, 0, -1):
        ...
        dx[:, i - 1, :], dprev_h, dWx_cur, dWh_cur, db_cur = rnn_step_backward(dcur_h, cur_cache)
